...
namespace TobeMvcPractise.Tests.Controllers
{
    ...
    public class EmployeeEntityControllerTest
    {
        ...
        {
            var employees = QueryableEmployees();

            var mockSet = GetMockSetForQuery(employees);
        ...
        public void EmployeeEntity_Details_With_Correct_Id_Mock()
        {
            ...
            int expectedId = 1;
            mockContext.Setup(m => m.Employees.Find(expectedId)).Returns(employees.ElementAt(expectedId - 1));
        ...
        [TestMethod]
        public void EmployeeEntity_Create_With_Employee()
        {
            var mockSet = GetMockSet();
        ...
        private IQueryable<Employee> QueryableEmployees()
        {
            return new List<Employee>() {
                new Employee {Id=1, Name="John" , Age=19, JoiningDate=DateTime.Today},
                new Employee {Id=2, Name="Ada" , Age=47, JoiningDate=DateTime.Today},
                new Employee {Id=3, Name="Loveth" , Age=23, JoiningDate=DateTime.Today }
            }.AsQueryable();
        }
        ...
        private Mock<DbSet<Employee>> GetMockSetForQuery(IQueryable<Employee> employees)
        {
